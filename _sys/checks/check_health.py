...
def _update_health_json(health_file: Path, size_mb: float, status: str) -> None:
...
def main() -> None:
    ...
    health_file = _SYS_DIR / "claude" / "health.json"
    ...
    _update_health_json(health_file, size_mb, health_status)
