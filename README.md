...
```
_sys\context\CLAUDE_global.md 를 _sys\claude\config\CLAUDE.md 로 복사 후 편집
```
...
8. (권장) 전역 설정 생성
   copy _sys\context\CLAUDE_global.md _sys\claude\config\CLAUDE.md
```
...
```
_sys\context\CLAUDE_project.md 를 [project]\CLAUDE.md 로 복사 후 편집
```
