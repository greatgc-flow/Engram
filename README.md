<div align="center">
  ...
  [![Tests: 1151 green](https://img.shields.io/badge/tests-1151%20green-brightgreen.svg)](_sys/tests/unit)
</div>
...
- **Validation:** tiered TDD suite under [`_sys/tests/unit`](_sys/tests/unit) — `l1_core`, `l2_policy`, `l3_mocked` — **1151 passing**, plus consistency checks (`check_cli_reality`, `check_cli_canary`, `check_contracts`, `check_sandbox_behavior`, `check_operational_guard_matrix`, `check_peer_characteristics`, `check_peer_capability_canary`, `check_capability`). Test count last verified 2026-07-17.
